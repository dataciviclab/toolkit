...
Il toolkit espone **15 tool** MCP per agenti AI e IDE:

| Categoria | Tool |
|---|---|
| **Catalogo** | `toolkit_find`, `toolkit_dataset_overview` |
| **Pipeline (aggregati)** | `toolkit_layer`, `toolkit_status` |
| **Pipeline (ispezione)** | `toolkit_inspect_paths`, `toolkit_inspect_schema`, `toolkit_inspect_profile`, `toolkit_list_runs`, `toolkit_schema_diff`, `toolkit_preflight` |
