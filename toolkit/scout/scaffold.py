...
# ---------------------------------------------------------------------------
# Funzioni spostate da scout.infer (sono logica di scaffold, non inferenza)
# ---------------------------------------------------------------------------
...
def suggest_clean_sql(
    ...
    mapping = profile.get("mapping_suggestions") or {}
    lines = ["-- Auto-generated by toolkit init --url", "-- Personalizza le trasformazioni qui sotto.", "SELECT"]
    select_parts = []
